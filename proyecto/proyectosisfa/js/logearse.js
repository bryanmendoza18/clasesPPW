...
async function registrarNuevoUsuario() {
  ...
  await swal.fire({
    ...
    showConfirmButton: false,
    html: `
        <input class="swal2-input" placeholder="cedula" id="cedula">
        <input class="swal2-input" placeholder="Ingrese nombre y apellido" id="nombreA">
    ...
    preConfirm: () => {
      ...
      if (!cedula) {
        Swal.showValidationMessage("Te faltó ingresar tu cédula");
        return false;
      }
      if (!usuario) {
...
async function login() {
  await swal.fire({
    ...
    preConfirm: () => {
      ...
      window.location="../html/menu-principal.html"
      return true ;
